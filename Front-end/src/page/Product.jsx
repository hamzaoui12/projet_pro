      ...
      <div className="flex flex-col justify-between lg:flex-row p-6 lg:p-24 gap-6 lg:gap-16 lg:items-center">
        ...
        <div className="flex flex-col gap-4 lg:w-2/4">
          ...
          <p className="text-gray-700">
            ...
            numquam voluptate quod vitae excepturi odio obcaecati? Sitlaudantium
            id dignissimos necessitatibus autem obcaecati non, praesentium
            debitis. Rem officia veniam consectetur. Lorem ipsum dolor sit amet
            consectetur adipisicing elit. Excepturi porro eos iste blanditiis
            autem tempore ullam, numquam reiciendis, mollitia commodi nobis
            error! Blanditiis, voluptatem tempore. Et, cupiditate. A, libero
            alias?
          </p>
