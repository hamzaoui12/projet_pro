...
const Connexion = () => {
  ...
  const handleSubmit = (values) => {
    const response = axios.post("http://localhost:3300/sign-in/",
      {
        mail: values.mail,
        ...
        >
          ...
          <div className="w-full flex flex-col my-6">
            <div className="flex justify-center">
              <button type="submit" className="w-full text-white m-1 bg-black rounded-md p-4 text-center flex items-center justify-center text-xl font-semibold">
                Log in
              </button>
            </div>
            <div className="flex justify-center">
